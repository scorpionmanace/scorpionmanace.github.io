const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-DXdFHFF5.js","assets/vendor-mYFzaRka.js","assets/About-oL7lEWwk.js","assets/Breadcrumbs-CByg_1Os.js","assets/JSONParserView-DI1L9LHz.js","assets/ColorPickerView-DBvyqyVT.js","assets/Tools-DEAoXjST.js","assets/ChakraUIView-CLDag0A7.js"])))=>i.map(i=>d[i]);
import { u as useBreakpointValue, j as jsxRuntimeExports, B as Box, F as Flex, L as Link, T as Text, H as Heading, a as Link$1, R as React, r as reactExports, b as Routes, c as Route, d as createSystem, e as clientExports, C as ChakraProvider, f as BrowserRouter, g as defaultConfig } from "./vendor-mYFzaRka.js";
(function polyfill() {
...
const Home = React.lazy(() => __vitePreload(() => import("./Home-DXdFHFF5.js"), true ? __vite__mapDeps([0,1]) : void 0));
const About = React.lazy(() => __vitePreload(() => import("./About-oL7lEWwk.js").then((n) => n.A), true ? __vite__mapDeps([2,1,3]) : void 0));
const JSONParserView = React.lazy(() => __vitePreload(() => import("./JSONParserView-DI1L9LHz.js"), true ? __vite__mapDeps([4,1,3]) : void 0));
const ColorPickerView = React.lazy(() => __vitePreload(() => import("./ColorPickerView-DBvyqyVT.js"), true ? __vite__mapDeps([5,1]) : void 0));
const Tools = React.lazy(() => __vitePreload(() => import("./Tools-DEAoXjST.js"), true ? __vite__mapDeps([6,1,3]) : void 0));
const ChakraUIView = React.lazy(() => __vitePreload(() => import("./ChakraUIView-CLDag0A7.js"), true ? __vite__mapDeps([7,1]) : void 0));
const App = () => {
...
if (!container) {
  ...
  try {
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChakraProvider, { value: system, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) })
    );
